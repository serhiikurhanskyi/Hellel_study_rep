...
double = [x for x in list_a if list_a.count(x) > 1]
print(double)

# Поменять местами самый большой
# и самый маленький элементы списка
list_3 = [2, 4, 5, 6, 8]
max_ = list_3.index(max(list_3))
min_ = list_3.index(min(list_3))
list_3[max_], list_3[min_] = list_3[min_], list_3[max_]
print(list_3)
